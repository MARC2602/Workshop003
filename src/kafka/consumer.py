...
try:
    conn = psycopg2.connect(
        host="192.168.100.2", #Ip de mi maquina virtual donde están los contenedores
        port="5432",
...
consumer = KafkaConsumer(
    'happiness_topic',
    bootstrap_servers=['192.168.100.2:9092'], #Ip de mi maquina virtual
...
for message in consumer:
    ...
    # Convertir la predicción a float (Por si acaso)
